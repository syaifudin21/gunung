...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-9">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('admin.user.store')}}">
                {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="username" id="staticEmail" placeholder="Username User" value="{{old('username')}}">
