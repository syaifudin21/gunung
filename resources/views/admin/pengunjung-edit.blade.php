...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" method="post" action="{{route('admin.pengunjung.update')}}">
                {{ csrf_field() }}
                <input type="hidden" name="id" value="{{$pengunjung->id}}"> @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama" value="{{$pengunjung->nama}}">
                                    @if ($errors->has('nama'))
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="username" id="username" placeholder="Username" value="{{$pengunjung->username}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" value="{{$pengunjung->alamat}}">
