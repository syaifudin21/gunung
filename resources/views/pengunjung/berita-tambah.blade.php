...
<main class="app-content">
    <div class="app-title">
        <div>
            ...
            <p>Tambah Berita gunung yang ada di Indonesia</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
			<div class="tile">
			  <div class="tile-body">
				<form class="form-horizontal" id="submit-form" enctype="multipart/form-data" method="post" action="{{route('pengunjung.berita.store')}}">
                {{ csrf_field() }}
