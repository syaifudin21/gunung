			...
			<div id="main">
				...
				<!-- Header -->
					<header id="header">
						...
						<nav>
							<ul>
								<li><a href="{{url('apk/download')}}" class="icon fa-mobile-phone">Download</a></li>
								<li><a href="{{url('/admin')}}" class="icon fa-user">Admin</a></li>
								<li><a href="{{url('/pengunjung')}}" class="icon fa-user-circle"> Pengunjung </a></li>
							</ul>
						</nav>
					</header>
